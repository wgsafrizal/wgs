            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Mixer</h1>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index">Home</a></li>
                            <li class="breadcrumb-item">Produksi</li>
                            <li class="breadcrumb-item active" aria-current="page">Mixer</li>
                        </ol>
                    </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="satuan">Tipe Produksi :</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="satuan">Kode Produksi :</label>
                                                    <input type="text" class="form-control form-control-sm  mb-3" id="divisi" autocomplete="off" name="divisi" placeholder="">
                                                </div>
                            ...
                            <footer class="sticky-footer bg-white">
                                <div class="container my-auto">
                                    <div class="copyright text-center my-auto">
                                        <span>copyright &copy; <script>
                                            ...
                                            <b><a href="https://indrijunanda.gitlab.io/" target="_blank">A.C.</a></b>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="container my-auto py-2">
                                    <div class="copyright text-center my-auto">
                                        <span>copyright &copy; <script>
                                                document.write(new Date().getFullYear());
                                            </script> - distributed to
                                            <b><a href="https://themewagon.com/" target="_blank"></a>Wira Gulfindo Sarana</b>
                                        </span>
                                    </div>
                                </div>
                            </footer>
