...
<style>
  /* Ganti #namabarang dengan ID yang sesuai */
#namabarang {
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
        ...
        <div style="color: red;" class="sidebar-brand-text mx-3" ></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="stocksummary">Master Barang</a>
            
            <a class="collapse-item" href="stocksummary">Stock Sumary</a>
    ...
    <!--   <li class="nav-item">
      ...
      <hr class="sidebar-divider">
      <div class="version" id="">Version 1.0</div>
    </ul>
    <!-- Sidebar -->
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <a href="#" class="btn btn-success btn-icon-split" data-toggle="modal" data-target="#exampleModalScrollable">
...
<!-- Add this datalist element inside your <form> -->
<div class="form-group">
    <label for="namabarang">Nama Barang:</label><select class="form-control" id="namabarang" name="namabarang">
    <!-- Options will be dynamically added here using JavaScript -->
</select>
</div>

<!-- Modify your script to populate the datalist with options from the server -->
<script>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="satuanEdit" name="satuanEdit" placeholder="Masukkan Satuan">
                    </div>
   ...
   <footer class="sticky-footer bg-white">
        ...
        <div class="container my-auto py-2">
          <div class="copyright text-center my-auto">
            <span>copyright &copy; <script> document.write(new Date().getFullYear()); </script> - distributed to
...
<!-- Your Select2 initialization script -->
<script>
  $(document).ready(function () {
    // Fetch data and populate options using Select2
    $('#namabarang').select2({
      width: '100%', // Sesuaikan dengan lebar yang diinginkan
      placeholder: 'Masukkan Nama Barang',
      ajax: {
        url: 'get_masterbarang.php', // Ganti dengan URL yang benar
        dataType: 'json',
        delay: 250,
